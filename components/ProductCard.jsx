        ...
        <NavigationLink href={`/watch/${watch.id}`}>
            ...
            >
                ...
                <div className="relative aspect-square overflow-hidden bg-gray-50">
                    ...
                    {/* Discount Badge */}
                    {discount > 0 && (
                        <div className={`absolute top-3 left-3 ${discount >= 50 ? 'bg-green-500' : 'bg-blue-600'} text-white text-xs font-bold px-2 py-1 rounded z-10 ${watch.isBestseller ? 'hidden md:block' : ''}`}>
                            {discount}% OFF
                        </div>
                    )}
